...
public class EpitaphConfig extends MidnightConfig {
    ...
    Gson gson = (new GsonBuilder()).excludeFieldsWithModifiers(new int[]{128}).excludeFieldsWithModifiers(new int[]{2}).addSerializationExclusionStrategy(new HiddenAnnotationExclusionStrategy()).excludeFieldsWithoutExposeAnnotation().setPrettyPrinting().create();
    ...
    @Entry(category = MESSAGES) @Expose
